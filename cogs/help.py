...
class Help(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="`/today`", value="Gets the games for today!", inline=False)
        embed.add_field(name="`/tomorrow`", value="Gets the games for tomorrow!", inline=False)
        embed.add_field(name="`/yesterday`", value="Gets the games from yesterday!", inline=False)
